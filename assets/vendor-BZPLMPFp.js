function BT(i){return i&&i.__esModule&&Object.prototype.hasOwnProperty.call(i,"default")?i.default:i}var Fu={exports:{}},Z={};/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function S_(i){const e=vn(i);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function XT(i,e,n){const s=vn(i);await Cl(s,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",yI)}async function JT(i,e,n){if(Ut(i.app))return Promise.reject(hn(i));const s=vn(i),d=await Cl(s,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",TI).catch(m=>{throw m.code==="auth/password-does-not-meet-requirements"&&S_(i),m}),f=await Sr._fromIdTokenResponse(s,"signIn",d);return await s._updateCurrentUser(f.user),f}function ZT(i,e,n){return Ut(i.app)?Promise.reject(hn(i)):RI(Ye(i),_i.credential(e,n)).catch(async s=>{throw s.code==="auth/password-does-not-meet-requirements"&&S_(i),s})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ek(i,{displayName:e,photoURL:n}){if(e===void 0&&n===void 0)return;const s=Ye(i),u={idToken:await s.getIdToken(),displayName:e,photoUrl:n,returnSecureToken:!0},d=await ci(s,PI(s.auth,u));s.displayName=d.displayName||null,s.photoURL=d.photoUrl||null;const f=s.providerData.find(({providerId:m})=>m==="password");f&&(f.displayName=s.displayName,f.photoURL=s.photoURL),await s._updateTokensIfNecessary(d)}function AI(i,e,n,s){return Ye(i).onIdTokenChanged(e,n,s)}function OI(i,e,n){return Ye(i).beforeAuthStateChanged(e,n)}function tk(i,e,n,s){return Ye(i).onAuthStateChanged(e,n,s)}function nk(i){return Ye(i).signOut()}const Tl="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const UT=300,zT=Mm("authIdTokenMaxAge")||UT;let Rm=null;const WT=i=>async e=>{const n=e&&await e.getIdTokenResult(),s=n&&(new Date().getTime()-Date.parse(n.issuedAtTime))/1e3;if(s&&s>zT)return;const l=n==null?void 0:n.token;Rm!==l&&(Rm=l,await fetch(i,{method:l?"POST":"DELETE",headers:l?{Authorization:`Bearer ${l}`}:{}}))};function ik(i=Wm()){const e=Rc(i,"auth");if(e.isInitialized())return e.getImmediate();const n=dI(i,{popupRedirectResolver:LT,persistence:[GI,LI,k_]}),s=Mm("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const u=new URL(s,location.origin);if(location.origin===u.origin){const d=WT(u.toString());OI(n,d,()=>d(n.currentUser)),AI(n,f=>d(f))}}const l=xm("auth");return l&&fI(n,`http://${l}`),n}function VT(){var i,e;return(e=(i=document.getElementsByTagName("head"))===null||i===void 0?void 0:i[0])!==null&&e!==void 0?e:document}iI({loadJS(i){return new Promise((e,n)=>{const s=document.createElement("script");s.setAttribute("src",i),s.onload=e,s.onerror=l=>{const u=Vt("internal-error");u.customData=l,n(u)},s.type="text/javascript",s.charset="UTF-8",VT().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});bT("Browser");export{Wn as G,HT as a,jT as b,Wm as c,YT as d,ik as e,$T as f,BT as g,qT as h,oE as i,GT as j,rk as k,ZT as l,JT as m,ek as n,QT as o,XT as p,tk as q,Dy as r,wC as s,nk as t,KT as u};
